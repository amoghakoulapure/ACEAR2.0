...
> Demo login:  
> **[amoghakoulapure@gmail.com](mailto:amoghakoulapure@gmail.com)**
...
1. Ship frontend via Vercel or Netlify
2. Configure environment variables
3. Serve backend/Auth via Supabase Hosting

***

## Contributing

1. Fork and create dedicated branches (`feature-x`, `bugfix-y`)
2. Keep dashboards and financial models transparency-centric
